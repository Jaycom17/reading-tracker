        ...
        <div className={`py-3 ${depth > 0 ? 'border-l-2 border-warm-gray/40 pl-4' : 'border-b border-warm-gray/30'}`}>
          ...
          <div className="flex items-center gap-3 mt-1">
            <button
              ...
              className="text-xs text-ink-light hover:text-gold-dark transition-colors"
            >
              Responder
            </button>
            {isCreator && onDeleteComment && (
              <button
                onClick={() => setDeleteConfirmId(comment.id)}
                className="inline-flex items-center gap-1 text-xs text-ink-light/40 hover:text-burgundy transition-colors"
  ...
  return (
    <div className="bg-paper-dark rounded-xl border border-warm-gray/60">
      ...
      <ConfirmModal
        ...
        onCancel={() => { setDeleteConfirmId(null); setError('') }}
